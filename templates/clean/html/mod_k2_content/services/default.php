...
<hr style="width:170px;">
  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <div class="moduleItemIntrotext wow fadeInDown  animated" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
      ...
      <?php endif; ?>
	  <hr style="width:170px; color:#c2c4c6;">
